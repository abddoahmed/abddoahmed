...
client.on("message", message => {
 ...
 if (message.content === "!help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Bot 1 | BLACK BINK』 『اسم البوت』", true)
     
      .addField("『مصمم البوت KOKA』", true)
...
if (message.content === '!invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/oauth2/authorize?client_id=511266229181480978&permissions=8&scope=bot ').catch(e => console.log(e.stack));
